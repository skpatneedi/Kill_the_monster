...
function setup(){
    ...
    GroundObject = new Ground(0, 600, width+width/2+90, 25);

    MonsterObject = new Monster(1100, 500, 200)

    SuperHeroObject = new Hero(200, 200, 80);

    FlyObject = new Fly(SuperHeroObject.body, {x:300, y:50})
}
...
function mouseDragged(){
    Matter.Body.setPosition(SuperHeroObject.body, {x:mouseX, y:mouseY})
}